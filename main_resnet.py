...
parser.add_argument('--use_function', default='piecewise', choices=['piecewise','continuous'],type=str,help='piecewise or continuous')
...
print_logger.info('-------------------------------------')
print_logger.info('Loading model ......')
...
total_flops=count_modelres_param_flops(model)
